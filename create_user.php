...
if (!checkAdmin()) {
    set_flash_message("red", "Нет прав админа");
    redirect_to("users.php");
}
if(isset($_POST['username']) && isset($_POST['password']) && $_POST['email']) {
    if(checEmailInDB($_POST["email"])) {
        set_flash_message("danger", "Пользователь уже зарегестрирован");
        redirect_to("create_user.php");
    }
    newUser($_POST['email'], $_POST['password'], $_POST['username'], $_POST['job'], $_POST['tel'], $_POST['address'], $_POST['photo'], $_POST['vk'],$_POST['telegram'], $_POST['instagram']);
